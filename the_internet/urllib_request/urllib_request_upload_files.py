...
class MultiPartForm:
    ...
    def add_file(self, fieldname, filename, fileHandle, mimetype=None):
        ...
        if mimetype is None:
            mimetype = (mimetype.guess_type(filename)[
                0] or 'application/octer-Stream')
...
if __name__ == "__main__":
    ...
    # Add a fake file
    form.add_file('biography', 'bio.text', fileHandle=io.BytesIO(
        b'Python developer and blogger'))
    data = bytes(form)
